 ...
 */
package com.app.frame.ui.SlideView;
...
public class SlideSwitch extends View {
    ...
    private static final int DEFAULT_COLOR_THEME = Color.parseColor("#38CBCB");
    // 3 attributes
    ...
    public void getDefaultText(Context context) {
        onText = context.getString(R.string.use_drug_remind_open);
        closeText = context.getString(R.string.use_drug_remind_close);
    }

    public void setSlindingOpenText(String textOpen) {
        this.onText = textOpen;
    }

    public void setCloseText(String textClose) {
        this.closeText = textClose;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (shape == SHAPE_RECT) {
            ...
            paint.setTextSize(DensityUtils.sp2px(mContext, 17));
            ...
            if (isOpen) {
                ...
                canvas.drawText(onText, 0, 20, 0, getHeight() / 2, paint);
            } else {
                paint.setTextAlign(Paint.Align.RIGHT);
                canvas.drawText(closeText, 0, 20, paint);
            }
            ...
            paint.setColor(Color.WHITE);
            paint.setTextSize(mContext.getResources().getDimension(R.dimen.select_state_textsize));
            canvas.drawRoundRect(frontCircleRect, radius, radius, paint);

            if (isOpen) {
                canvas.drawText(onText, 0, 2, min_left + 20, (getHeight() + DensityUtils.sp2px(mContext, 12)) / 2, paint);
            } else {
                canvas.drawText(closeText, 0, 2, getWidth() / 2, (getHeight() + DensityUtils.sp2px(mContext, 12)) / 2, paint);
            }
        }
    }
    ...
    public boolean getOpenState(boolean isOpen) {
        return isOpen;
    }
