...
import com.app.frame.ui.dialog.GlobalPopDialog;
...
public class PermissionTool {
    ...
    public static boolean getBasePermission(String permmision,Context context){

        PackageManager pm = context.getPackageManager();
        boolean permission = (PackageManager.PERMISSION_GRANTED ==
                pm.checkPermission(permmision,context.getPackageName()));
        return permission;
    }

    public static boolean isContactCanUse(Context context){
        PackageManager pm = context.getPackageManager();
        boolean permission = (PackageManager.PERMISSION_GRANTED ==
    ...
    public static boolean isHaveInsertContactLimit(Context context){
        return getBasePermission("android.permission.READ_CONTACTS",context);
    }
    ...
    private static void showMessageOKCancel(final Activity context, String message, DialogInterface.OnClickListener okListener) {
        GlobalPopDialog.createDialog(context, message, null, okListener);
    }
