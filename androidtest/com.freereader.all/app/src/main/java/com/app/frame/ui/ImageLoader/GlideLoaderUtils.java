...
public class GlideLoaderUtils {
    ...
    public String getCacheSize() {
        try {
            return getFormatSize(getFolderSize(new File(FileCacheManager.getInstance().getPublicImageCachePath())));
        } catch (Exception e) {
            e.printStackTrace();
            return "获取失败";
        }
    ...
    public boolean cleanCatchDisk() {
        return deleteFolderFile(FileCacheManager.getInstance().getPublicImageCachePath(), true);
    }
