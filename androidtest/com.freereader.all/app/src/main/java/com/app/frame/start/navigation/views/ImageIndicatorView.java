package com.app.frame.start.navigation.views;
...
public class ImageIndicatorView extends RelativeLayout {
    ...
    private void iniViewEdge() {

        try {
             leftEdgeField = viewPager.getClass().getDeclaredField("mLeftEdge");
             rightEdgeField = viewPager.getClass().getDeclaredField("mRightEdge");
    ...
    private boolean isCanDragEdge=false;
    public void setEdgeCanDrag(boolean flag)
    {
        isCanDragEdge=flag;
    }

    private OnPageEdgeDragListener mPageEdgeDragListener=null;
    public void setOnPageEdgeDragListener(OnPageEdgeDragListener listener)
    {
        mPageEdgeDragListener=listener;
    }
    ...
    private class PageChangeListener implements OnPageChangeListener {
        ...
        public void onPageScrollStateChanged(int arg0) {
         ...
         if(isCanDragEdge)
         {
             ...
             {
                 mPageEdgeDragListener.onDragEdge();
             }}
        }
    }
    ...
    public interface OnPageEdgeDragListener
    {
        void onDragEdge();
    }
